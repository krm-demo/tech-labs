...
public class TestCase_046__Permutations {
    ...
    @EnumSource
    @ParameterizedTest
    public void test_ex_01(Problem_046__Permutations.Solution sln) {
    ...
    @EnumSource
    @ParameterizedTest
    public void test_ex_02(Problem_046__Permutations.Solution sln) {
    ...
    @EnumSource
    @ParameterizedTest
    public void test_ex_03(Problem_046__Permutations.Solution sln) {
        assertThat(sln.permute(new int[] { 123 })).isEqualTo(List.of(List.of(123)));
    }

    @EnumSource
    @ParameterizedTest
    public void test_seven_perms(Problem_046__Permutations.Solution sln) {
