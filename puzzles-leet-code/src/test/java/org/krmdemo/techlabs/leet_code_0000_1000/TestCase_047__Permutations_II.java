...
public class TestCase_047__Permutations_II {
    ...
    @EnumSource
    @ParameterizedTest
    public void test_two_combo(Problem_047__Permutations_II.Solution sln) {
        final int M = 3;
        final int K = 2;
    ...
    @EnumSource
    @ParameterizedTest
    public void test_046_ex_01(Problem_047__Permutations_II.Solution sln) {
    ...
    @EnumSource
    @ParameterizedTest
    public void test_046_ex_02(Problem_047__Permutations_II.Solution sln) {
    ...
    @EnumSource
    @ParameterizedTest
    public void test_046_ex_03(Problem_047__Permutations_II.Solution sln) {
        assertThat(sln.permuteUnique(new int[] { 123 })).isEqualTo(List.of(List.of(123)));
    }

    @EnumSource
    @ParameterizedTest
    public void test_046_seven_perms(Problem_047__Permutations_II.Solution sln) {
