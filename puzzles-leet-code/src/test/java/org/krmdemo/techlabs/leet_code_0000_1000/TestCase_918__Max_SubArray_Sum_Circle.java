...
public class TestCase_918__Max_SubArray_Sum_Circle {
    ...
    @EnumSource
    @ParameterizedTest
    public void test_ex_01(Problem_918__Max_SubArray_Sum_Circle.Solution sln) {
        assertThat(sln.maxSubarraySumCircular(new int[] { 1, -2, 3, -2 })).isEqualTo(3);
    }

    @EnumSource
    @ParameterizedTest
    public void test_ex_02(Problem_918__Max_SubArray_Sum_Circle.Solution sln) {
        assertThat(sln.maxSubarraySumCircular(new int[] { 5, -3, 5 })).isEqualTo(10);
    }

    @EnumSource
    @ParameterizedTest
    public void test_ex_03(Problem_918__Max_SubArray_Sum_Circle.Solution sln) {
        assertThat(sln.maxSubarraySumCircular(new int[] { -3, -2, -3 })).isEqualTo(-2);
    }

    @EnumSource
    @ParameterizedTest
    public void test_tc_105_of_112(Problem_918__Max_SubArray_Sum_Circle.Solution sln) {
        assertThat(sln.maxSubarraySumCircular(new int[] { -3, -2, -1 })).isEqualTo(-1);
    }

    @EnumSource
    @ParameterizedTest
    public void test_empty(Problem_918__Max_SubArray_Sum_Circle.Solution sln) {
    ...
    @EnumSource
    @ParameterizedTest
    public void test_single(Problem_918__Max_SubArray_Sum_Circle.Solution sln) {
        assertThat(sln.maxSubarraySumCircular(new int[] { 123 })).isEqualTo(123);
    }

    @EnumSource
    @ParameterizedTest
    public void test_random(Problem_918__Max_SubArray_Sum_Circle.Solution sln) {
