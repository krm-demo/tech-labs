...
public class TestCase_2608__Shortest_Cycle_in_a_Graph {
    ...
    void test_ex_01() {
        ...
        assertThat(sln.findShortestCycle(N, edges)).isEqualTo(3);
    }
    ...
    void test_ex_02() {
        ...
        assertThat(sln.findShortestCycle(N, edges)).isEqualTo(-1);
    }
    ...
    void test_GFG_article_Shotest_Cycle() {
        ...
        // Output: 4
        // Explanation: The cycle with the smallest length is : 1 -> 6 -> 8 -> 5 -> 1
        final int N = 7;
        final int[][] edges = new int[][] {
            {3,2}, {3,4}, {2,6}, {1,6}, {1,5}, {1,4}, {5,0}, {6,0}
        };
        sln.findShortestCycle(N, edges);
        // TODO: fix the assertion below after counting minCycleCross
        //assertThat(sln.findShortestCycle(N, edges)).isEqualTo(4);
    }
}
